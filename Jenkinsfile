    ...
    stages {
        ...
        stage('Deploy Spring Boot to DEV') {
            steps {
                ...
                sh 'docker run -d --name university-springboot -p 8080:8080 --network host -e SPRING_DATASOURCE_URL=jdbc:postgresql://localhost:5432/universitymanagement -e SPRING_DATASOURCE_USERNAME=postgres -e SPRING_DATASOURCE_PASSWORD=123123 university-springboot:latest'
            }
        }
    }
