...
CREATE TABLE account.password_conversion
(
    id      BIGSERIAL PRIMARY KEY,
...
VALUES ('admin', '$2a$12$Vr9c8qtydVi39u4HAHXDGePAHShspu.o1sfZdFt5VQ2fZ2fJIb3MW', 'admin@gmail.com',
       ...
       ('alex_smith', '$2a$12$R.AMxKQntUYWOAQaRl0RDOLcdPW9OUHPSBkG64cVo6LCqtbNqYDhC', 'alexsmith@example.com',
        CURRENT_TIMESTAMP,
        'VuLH26', TRUE),
       ('alex_smith1', '$2a$12$R.AMxKQntUYWOAQaRl0RDOLcdPW9OUHPSBkG64cVo6LCqtbNqYDhC', 'alexsmith1@example.com',
       CURRENT_TIMESTAMP,
         'VuLH26', TRUE),
       ('alex_smith2', '$2a$12$R.AMxKQntUYWOAQaRl0RDOLcdPW9OUHPSBkG64cVo6LCqtbNqYDhC', 'alexsmith2@example.com',
       CURRENT_TIMESTAMP,
          'VuLH26', TRUE),
       ('alex_smith3', '$2a$12$R.AMxKQntUYWOAQaRl0RDOLcdPW9OUHPSBkG64cVo6LCqtbNqYDhC', 'alexsmith3@example.com',
        CURRENT_TIMESTAMP,
        'VuLH26', TRUE),
       ('alex_smith4', '$2a$12$R.AMxKQntUYWOAQaRl0RDOLcdPW9OUHPSBkG64cVo6LCqtbNqYDhC', 'alexsmith4@example.com',
        CURRENT_TIMESTAMP,
        'VuLH26', TRUE),
       ('alex_smith5', '$2a$12$R.AMxKQntUYWOAQaRl0RDOLcdPW9OUHPSBkG64cVo6LCqtbNqYDhC', 'alexsmith5@example.com',
       CURRENT_TIMESTAMP,
       'VuLH26', TRUE),
       ('alex_smith6', '$2a$12$R.AMxKQntUYWOAQaRl0RDOLcdPW9OUHPSBkG64cVo6LCqtbNqYDhC', 'alexsmith6@example.com',
        CURRENT_TIMESTAMP,
        'VuLH26', TRUE),
       ('alex_smith7', '$2a$12$R.AMxKQntUYWOAQaRl0RDOLcdPW9OUHPSBkG64cVo6LCqtbNqYDhC', 'alexsmith7@example.com',
        CURRENT_TIMESTAMP,
        'VuLH26', TRUE),
        ('alex_smith8', '$2a$12$R.AMxKQntUYWOAQaRl0RDOLcdPW9OUHPSBkG64cVo6LCqtbNqYDhC', 'alexsmith8@example.com',
        CURRENT_TIMESTAMP,
        'VuLH26', TRUE),
        ('alex_smith9', '$2a$12$R.AMxKQntUYWOAQaRl0RDOLcdPW9OUHPSBkG64cVo6LCqtbNqYDhC', 'alexsmith9@example.com',
        CURRENT_TIMESTAMP,
        'VuLH26', TRUE),
        ('alex_smith15', '$2a$12$R.AMxKQntUYWOAQaRl0RDOLcdPW9OUHPSBkG64cVo6LCqtbNqYDhC', 'alexsmith11@example.com',
        CURRENT_TIMESTAMP,
        'VuLH26', TRUE),
        ('alex_smith10', '$2a$12$R.AMxKQntUYWOAQaRl0RDOLcdPW9OUHPSBkG64cVo6LCqtbNqYDhC', 'alexsmith10@example.com',
        CURRENT_TIMESTAMP,
        'VuLH26', TRUE),
        ('alex_smith11', '$2a$12$R.AMxKQntUYWOAQaRl0RDOLcdPW9OUHPSBkG64cVo6LCqtbNqYDhC', 'alexsmith12@example.com',
        CURRENT_TIMESTAMP,
        'VuLH26', TRUE),
        ('alex_smith12', '$2a$12$R.AMxKQntUYWOAQaRl0RDOLcdPW9OUHPSBkG64cVo6LCqtbNqYDhC', 'alexsmith13@example.com',
        CURRENT_TIMESTAMP,
        'VuLH26', TRUE),
        ('alex_smith14', '$2a$12$R.AMxKQntUYWOAQaRl0RDOLcdPW9OUHPSBkG64cVo6LCqtbNqYDhC', 'alexsmith14@example.com',
        CURRENT_TIMESTAMP,
        'VuLH26', TRUE),
